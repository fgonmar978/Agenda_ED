...
{	
	...
	public Contacto(String nombre, String apellidos, LocalDate fechaNac, String telefono) {
	...
	public Contacto(String nombre, String apellidos, LocalDate fechaNac, String correo, String telefono) {
		super(nombre, apellidos, fechaNac);
		this.telefono = telefono;
		this.correo = correo;
	...
	public Contacto(String nombre, String apellidos, LocalDate fechaNac, String correo, String telefono, short prefijo) {
		super(nombre, apellidos, fechaNac);
		this.telefono = telefono;
		this.correo = correo;
